...
public class MainController {
    ...
    private Image getWeatherIcon(String description) {
        ...
        return switch (description.toLowerCase()) {
            case "ясно" -> new Image(Objects.requireNonNull(getClass().getResourceAsStream("sun.png")));
            case "облачно с прояснениями" -> new Image(Objects.requireNonNull(getClass().getResourceAsStream("clouds.png")));
            case "пасмурно" -> new Image(Objects.requireNonNull(getClass().getResourceAsStream("clouds.png")));
            case "переменная облачность" -> new Image(Objects.requireNonNull(getClass().getResourceAsStream("sun-clouds.png")));
            case "небольшая облачность" -> new Image(Objects.requireNonNull(getClass().getResourceAsStream("clouds.png")));
            case "небольшой дождь" -> new Image(Objects.requireNonNull(getClass().getResourceAsStream("sun-clouds-rain.png")));
            case "дождь" -> new Image(Objects.requireNonNull(getClass().getResourceAsStream("rain.png")));
            case "небольшой снег" -> new Image(Objects.requireNonNull(getClass().getResourceAsStream("clouds-snow.png")));
            default -> new Image(Objects.requireNonNull(getClass().getResourceAsStream("idk.jpg")));
        };
    }
}
